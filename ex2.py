def imprimir_tabuleiro(tabuleiro):
    ...
    for linha in tabuleiro:
        ...
        print("-" * (4 * len(linha) - 1))  # Imprime uma linha de traços para separar as linhas
...
#Funcao principal 
def jogo_da_velha():
    tamanho = int(input("Digite o tamanho do tabuleiro (3 para 3x3, 4 para 4x4, etc.): "))
    tabuleiro = criar_tabuleiro(tamanho)  # Cria o tabuleiro vazio com o tamanho especificado
    jogador = "X"  # Começa com o jogador X
    movimentos = 0

    print(f"Bem-vindo ao Jogo da Velha {tamanho}x{tamanho}!")
